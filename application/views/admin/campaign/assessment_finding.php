  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?= trans('assessment_findings_for') ?><?=$theArea['name']?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php echo form_open(base_url('admin/campaign/make_assessment_finding'), 'class="form-horizontal"');  ?>
