              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php echo form_open(base_url('admin/campaign/make_assessment'), 'class="form-horizontal"');  ?>
                            ...
                            <?php if($category['questions'] != null): ?>
                                <?php foreach($category['questions'] as $question): ?>
                                    <tr id="question_row_<?=$category['id']?>" >
                                        ...
                                        <td data-type="point">
                                            <label>
                                                <input type="radio" value="1" checked class="flat-red" name="question_point_<?=$question['id']?>">
                                            </label>
                                        </td>
                                        <td data-type="point">
                                            <label>
                                                <input type="radio" value="2" class="flat-red" name="question_point_<?=$question['id']?>">
                                            </label>
                                        </td>
                                        <td data-type="point">
                                            <label>
                                                <input type="radio" value="3" class="flat-red" name="question_point_<?=$question['id']?>">
                                            </label>
                                        </td>
                                        <td data-type="point">
                                            <label>
                                                <input type="radio" value="4" class="flat-red" name="question_point_<?=$question['id']?>">
                                            </label>
                                        </td>
                                        <td data-type="point">
                                            <label>
                                                <input type="radio" value="5" class="flat-red" name="question_point_<?=$question['id']?>">
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <div class="form-group">
                                                  <div>
                                                      ...
                                                      <div class="col-md-12">
																													...
																													<div id="display_best_photo_<?=$question['id']?>" class="col-md-12">
																															
																												
																													</div>
																												
                                                        <input class="flat-red" type="file" name="photo_best_practice_<?=$question['id']?>" id="photo_best_practice_<?=$question['id']?>" onchange="fileSelected('<?=$question['id']?>',1);" accept="image/*" capture="camera" />
                                                      </div>
                                                    </div>
                                                  <div id="photo_best_details_<?=$question['id']?>"></div>

                                                  <div class="col-md-12">
																											<div class="col-md-12">
																												<input class="flat-red" type="button" data-input="<?=$question['id']?>" onclick="uploadFile('<?=$question['id']?>',1)" value="Upload" />
																											</div>
                                                  </div>

                                                  <div id="best_progress_<?=$question['id']?>"></div>
                                                </div>
                                              </div>
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                  <div>
																											...
																											<div class="col-md-12">
																														<div class="col-md-12">
																																	...
																																	<div id="display_finding_photo_<?=$question['id']?>" class="col-md-12">
																																			
																																			
											
																																	</div>
																																
																															<input type="file" name="photo_finding_<?=$question['id']?>" id="photo_finding_<?=$question['id']?>" onchange="fileSelected('<?=$question['id']?>',2);" accept="image/*" capture="camera" />
																														</div>
																									</div>
                                                  <div id="photo_finding_details_<?=$question['id']?>"></div>
                                                  
                                                  <div class="col-md-12">
																											<div class="col-md-12">
																											<input class="flat-red" type="button" data-input="<?=$question['id']?>" onclick="uploadFile('<?=$question['id']?>',2)" value="Upload" />
																											</div>
                                                  </div>
                                                  		<div id="finding_progress_<?=$question['id']?>"></div>
                                                  </div>
                                              </div>
                                            </div>
                                        </td>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                        <input type="submit" name="submit" value="<?= trans('add_evaluation') ?>" class="btn btn-primary pull-right">
                        </div>
                  </div>
                    <?php echo form_close(); ?>                      
                  </div>
