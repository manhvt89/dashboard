              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php echo form_open(base_url('admin/campaign/make_general_comment'), 'class="form-horizontal"');  ?> 
                    ...
                    <label for="archivement" class="col-md-12 control-label">Kết quả đạt được</label>

                    <div class="col-md-12">
                      <textarea style="width:100%; min-height:300px;" name="archivement" class="form-control vx-editer" id="archivement"></textarea>
                      <input type="hidden" name="id" class="form-control" id="id" placeholder="" value="<?=$record['id']?>">
                    </div>
                  </div>
									<div class="form-group">
                    <label for="main_problem" class="col-md-12 control-label">Tồn tại chính</label>

                    <div class="col-md-12">
                      <textarea style="width:100%; min-height:300px;" name="main_problem" class="form-control vx-editer" id="main_problem"></textarea>
                      
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="submit" name="submit" value="<?= trans('btn_add_comment') ?>" class="btn btn-primary pull-right">
                    </div>
                  </div>
                  <?php echo form_close(); ?>
                </div>
