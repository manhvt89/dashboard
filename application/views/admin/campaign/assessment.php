                  ...
                  <div class="col-md-12">
                    ...
                    <?php echo form_open(base_url('admin/campaign/make_assessment'), 'class="form-horizontal"');  ?>
                        ...
                        <table class="responsive-table" width="90%">
                                            ...
                                            <div class="row">
																									...
																									<div class="row">
																										...
																										<div class="col-md-3 image-upload">
																											<label for="photo_best_practice_u_0">
																												...
																												<input class="flat-red" type="file" name="photo_best_practice_u_0" id="photo_best_practice_u_0" onchange="fileSelected_u('0',1);" accept="image/*" />
																											</div>
																									</div>
																									<!--
																									<div class="row">
                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group">
																									...
																									<div class="row">
																											<div class="col-md-3 image-capture">
																												<label for="photo_finding_0">
																														<img src="<?=base_url('assets/dist/img/capture.png')?>"/>
																												</label>
																													<input type="file" name="photo_finding_0" id="photo_finding_0" onchange="fileSelected('0',2);" accept="image/*" capture="camera" />
																											</div>
																											<div class="col-md-3 image-upload">
																												<label for="photo_finding_u_0">
																														<img src="<?=base_url('assets/dist/img/upload.png')?>"/>
																												</label>
																												<input type="file" name="photo_finding_u_0" id="photo_finding_u_0" onchange="fileSelected_u('0',2);" accept="image/*" />
																											</div>
																									</div>
																									<!--
																									<div class="row">
                            ...
                            <tr><td rowspan="2" data-title="heading">Tiêu chí đánh giá</td><td colspan = "5" data-title="heading" width="20%">Điểm đánh giá</td></tr>
...
<script type="text/javascript">
	function fileSelected_u(id,type) {
		if(type == 1)
		{

			var _name = 'photo_best_practice_u_'+id;
		...
		uploadFile_u(id,type);
	}

	function uploadFile_u(id,type){
		if(type ==1)
		{
			var _name = 'photo_best_practice_u_'+id;
			var _name_display = "photo_best_details_" + id;
      ...
      var uploadComplete = function(type, evt) {
        ...
        /* This event is raised when the server send back a response */
				...
				$('#'+_display_best_photo).prepend(item);
