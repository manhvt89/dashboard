...
// Tích hợp ckfinder với CI, lấy session từ CI, thông tin user đăng nhập
ob_start();
...
$config['licenseName'] = '5s.es.edu.vn';
$config['licenseKey']  = '6EYE2WHUBLN8HC846EA936KCR84HV';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => "/ckfinder/$username/",
    //'baseUrl'      => '/ckfinder/',
	//'root'         => '/home/5s.es.edu.vn/public_html/ckfinder/superadmin',
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
